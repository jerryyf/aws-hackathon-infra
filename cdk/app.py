...
cdk.Tags.of(app).add("Project", "aws-bidopsai")
cdk.Tags.of(app).add("Environment", environment)
cdk.Tags.of(app).add("Owner", os.getenv("OWNER", "bidopsai-team"))
cdk.Tags.of(app).add("CostCenter", os.getenv("COST_CENTER", "bidopsai"))
